...
|
*/
$config['base_url']	= "http://pauling.mikexstudios.com/memorize_chinese/";
...
|
*/
$config['encryption_key'] = "chinese_memorize";
...
$config['sess_database']            = 'development'; //Set to db connection name
