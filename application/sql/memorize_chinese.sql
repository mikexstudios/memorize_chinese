...
--
-- Host: localhost
-- Generation Time: Nov 24, 2007 at 08:57 PM
...
(201, 7, '事', 'shì', 'thing, event; 事情 shìqing situation'),
(202, 7, '闹', 'nào', '(热闹) noisy; 闹钟 alarm clock'),
(203, 7, '翻', 'fān', 'turn over; 翻译 fānyì translate'),
(204, 7, '详', 'xiáng', '详细 detailed; 端详 details; 安详 serene'),
(205, 7, '细', 'xì', 'thin; 仔细 zǐxì careful; 细胞 xìbāo cell; 详细 detailed'),
(206, 7, '况', 'kuàng', '情况 circumstances; 况且 moreover'),
(207, 7, '性', 'xìng', 'sex; nature; -ness'),
(208, 7, '格', 'gé', 'check, pattern, standard; 格外 géwài especially  [gē]'),
(209, 7, '朗', 'lǎng', '爽朗 shuǎnglǎng, 明朗 bright & clear; 朗讼 recite'),
(210, 7, '脾', 'pí', 'spleen; 脾气 píqi (bad-) temper'),
(211, 7, '急', 'jí', 'urgent; 着急 zháojí anxious; 急忙 jímáng in a hurry'),
(212, 7, '躁', 'zào', 'rash, impetuous'),
(213, 7, '趣', 'qù', 'interest, fun; 兴趣 interest; 趣味 interest; taste'),
(214, 7, '戏', 'xì', '(戏剧 xìjù) drama, play; 游戏 yóuxì game'),
(215, 7, '古', 'gǔ', '(古代 gǔdài) ancient'),
(216, 7, '典', 'diǎn', '典型 diǎnxíng typical; 古典 classical; 词典 dictionary'),
(217, 7, '摇', 'yáo', 'shake'),
(218, 7, '滚', 'gǔn', 'roll; boil'),
(219, 7, '往', 'wǎng', 'to, toward; 往往 wǎngwǎng often'),
(220, 7, '相', 'xiāng', 'each other, mutual  [xiàng] look at; appearance; photo'),
(221, 7, '背', 'bèi', 'back  [bēi] carry on the back'),
(222, 7, '景', 'jǐng', 'scene, scenery'),
(223, 7, '噢', 'ō', 'Oh (interjection)'),
(224, 7, '醉', 'zuì', 'drunk'),
(225, 7, '厉', 'lì', '厉害 terrible; formidable  [lài] (name of ancient country)'),
(226, 7, '害', 'hài', 'harmful; 害虫 hàichóng destructive insect; 厉害 lìhai fierce'),
(227, 7, '镜', 'jìng', '(镜子) mirror; lens; 眼镜 yǎnjìng glasses'),
(228, 7, '破', 'pò', 'smash; 破坏 pòhuài ruin; 破烂 pòlàn worn out'),
(229, 7, '吹', 'chuī', 'blow'),
(230, 7, '怪', 'guài', 'blame; (奇怪 qíguài) strange; 怪物 guàiwu monster'),
(231, 7, '挺', 'tǐng', 'quite, very; endure, stand; 挺立 stand upright'),
(232, 7, '悔', 'huǐ', '(后悔 hòuhuǐ) regret, repent'),
(233, 7, '假', 'jiǎ', 'false  [jià] (假期 jiàqī) vacation'),
(234, 7, '憋', 'biē', 'check, restrain, suppress; suffocate, feel depressed'),
(235, 7, '死', 'sǐ', 'die, death'),
(236, 7, '演', 'yǎn', '(表演 biǎoyǎn) perform, act, performance'),
(237, 7, '部', 'bù', '(部分 bùfen) part; 西部 western part; 全部 entire'),
(238, 7, '谈', 'tán', 'talk'),
(239, 7, '华', 'huá', 'magnificent; China    [Huà] (surname); 华山'),
(240, 7, '姆', 'mǔ', 'nurse; 汤姆 Tāngmǔ Tom'),
(241, 7, '丽', 'lì', '美丽 beautiful; 壮丽 majestic  [Lí] Korea'),
(242, 7, '莎', 'shā', '(used in names)  [suō] 莎草 (a kind of plant)');

-- --------------------------------------------------------

--
-- Table structure for table `cards_test`
--

DROP TABLE IF EXISTS `cards_test`;
CREATE TABLE `cards_test` (
  `id` int(100) NOT NULL auto_increment,
...
--
-- Dumping data for table `cards_test`
--

INSERT INTO `cards_test` (`id`, `category`, `question`, `answer`, `extra`) VALUES
(1, 'Lesson 4', '我', 'wo3', ''),
(2, 'Lesson 4', '他', 'ta1', '');
...
('15a1f2511f803f7675efdb128a301df4', 1195894618, 1195966289, '127.0.0.1', 'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv', 'a:2:{s:21:"current_answer_rating";i:1;s:11:"card_number";i:35;}');
...
CREATE TABLE `user_progress` (
  ...
  `answer_rating` float NOT NULL,
  `date_answered` int(10) NOT NULL,
  `time_to_answer` int(10) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
